insert into weapon_types (weapon_type_id, cost, damage, radius, damage_type_id, name_ru, dsc_ru)
values (1, 10000, 10, 270, 3, 'Промышленный лазер',
...
insert into weapon_types (weapon_type_id, cost, damage, radius, damage_type_id, name_ru, dsc_ru)
values (2, 15000, 15, 216, 1, 'Осколочное орудие',
        'Плазменное орудие с увеличенными поражающими характеристиками');

insert into weapon_types (weapon_type_id, cost, damage, radius, damage_type_id, name_ru, dsc_ru)
values (3, 50000, 30, 342, 2, 'Дезинтегратор',
